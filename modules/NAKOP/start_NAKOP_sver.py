...
from modules.NAKOP.get_NAKOP_data import get_osfr_data
from modules.NAKOP.get_NAKOP_matches import get_NAKOP_matches
from modules.NAKOP.reformat_csv_NAKOP_data import reformat_popay_data, reformat_wpr_data


def start_NAKOP_sver(in_path, db_conn, db_curs):
    try:
        ...
        # Задаем название столбцам
        col_names = ['POPAY_AMOUNT', 'POPAY_ID', 'POPAY_NP', 'POPAY_NVP', 'POPAY_SPOSOB', 'POPAY_VIDVPL']
        ...
        get_NAKOP_matches(db_curs, osfr_db=db_osfr_name, man_db=db_man_name, popay_db=db_popay_name, wpr_db=db_wpr_name)
